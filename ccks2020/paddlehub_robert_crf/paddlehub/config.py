...
parser.add_argument("--do_model", type=str, default="mrc_relaiton", choices=["mcls", "role","mcls_onlysentence",'mrc_relation'], help="trigger or role")
...
parser.add_argument("--use_cross_validation",type=ast.literal_eval, default=True, help="yes or no")
parser.add_argument("--cross_validation_num", type=int, default=5, help="几折交叉")
parser.add_argument("--return_logits",type=ast.literal_eval, default=True, help="yes or no")
